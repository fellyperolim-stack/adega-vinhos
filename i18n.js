    ...
    var DICT = {
        pt: {
            ...
            cadastro: {
                ...
                artigo_step_title: 'Quer gerar um artigo pra esse vinho?',
                artigo_step_subtitle: 'A IA escreve um texto tipo resenha de blog a partir do que você preencheu. Dá pra editar antes de publicar.',
                artigo_btn_generate: 'Gerar Artigo com IA',
                artigo_btn_skip: 'Pular, fazer depois',
                artigo_btn_retry: 'Tentar de novo',
                artigo_btn_approve: 'Aprovar e Publicar',
                artigo_btn_regenerate: 'Gerar Novamente',
                artigo_status_generating: 'Gerando artigo com IA...',
                artigo_status_error: 'Erro ao gerar o artigo.',
                artigo_status_offline: 'IA offline.',
                artigo_status_saving: 'Salvando...',
                artigo_status_save_error: 'Não foi possível salvar o artigo.',
        ...
        en: {
            ...
            cadastro: {
                ...
                artigo_step_title: 'Want to generate an article for this wine?',
                artigo_step_subtitle: 'The AI writes a blog-style review from what you entered. You can edit it before publishing.',
                artigo_btn_generate: 'Generate Article with AI',
                artigo_btn_skip: 'Skip, do it later',
                artigo_btn_retry: 'Try again',
                artigo_btn_approve: 'Approve & Publish',
                artigo_btn_regenerate: 'Regenerate',
                artigo_status_generating: 'Generating article with AI...',
                artigo_status_error: 'Error generating the article.',
                artigo_status_offline: 'AI offline.',
                artigo_status_saving: 'Saving...',
                artigo_status_save_error: 'Could not save the article.',
        ...
        es: {
            ...
            cadastro: {
                ...
                artigo_step_title: '¿Quieres generar un artículo para este vino?',
                artigo_step_subtitle: 'La IA escribe una reseña estilo blog a partir de lo que completaste. Puedes editarlo antes de publicar.',
                artigo_btn_generate: 'Generar Artículo con IA',
                artigo_btn_skip: 'Omitir, hacerlo después',
                artigo_btn_retry: 'Intentar de nuevo',
                artigo_btn_approve: 'Aprobar y Publicar',
                artigo_btn_regenerate: 'Generar de Nuevo',
                artigo_status_generating: 'Generando artículo con IA...',
                artigo_status_error: 'Error al generar el artículo.',
                artigo_status_offline: 'IA fuera de línea.',
                artigo_status_saving: 'Guardando...',
                artigo_status_save_error: 'No se pudo guardar el artículo.',
        ...
        it: {
            ...
            cadastro: {
                ...
                artigo_step_title: 'Vuoi generare un articolo per questo vino?',
                artigo_step_subtitle: 'L’IA scrive una recensione in stile blog basata su ciò che hai inserito. Puoi modificarla prima di pubblicare.',
                artigo_btn_generate: 'Genera Articolo con IA',
                artigo_btn_skip: 'Salta, fai dopo',
                artigo_btn_retry: 'Riprova',
                artigo_btn_approve: 'Approva e Pubblica',
                artigo_btn_regenerate: 'Genera di Nuovo',
                artigo_status_generating: 'Generazione articolo con IA...',
                artigo_status_error: 'Errore nella generazione dell’articolo.',
                artigo_status_offline: 'IA offline.',
                artigo_status_saving: 'Salvataggio...',
                artigo_status_save_error: 'Impossibile salvare l’articolo.',
        ...
        fr: {
            ...
            cadastro: {
                ...
                artigo_step_title: 'Voulez-vous générer un article pour ce vin ?',
                artigo_step_subtitle: 'L’IA rédige un texte façon blog à partir de ce que vous avez saisi. Vous pouvez le modifier avant de le publier.',
                artigo_btn_generate: 'Générer un Article avec l’IA',
                artigo_btn_skip: 'Passer, le faire plus tard',
                artigo_btn_retry: 'Réessayer',
                artigo_btn_approve: 'Approuver et Publier',
                artigo_btn_regenerate: 'Régénérer',
                artigo_status_generating: 'Génération de l’article avec l’IA...',
                artigo_status_error: 'Erreur lors de la génération de l’article.',
                artigo_status_offline: 'IA hors ligne.',
                artigo_status_saving: 'Enregistrement...',
                artigo_status_save_error: 'Impossible d’enregistrer l’article.',
